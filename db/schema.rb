...
ActiveRecord::Schema.define(version: 20171228180759) do
  ...
  create_table "annotations", force: :cascade do |t|
    ...
    t.index ["song_instance_id"], name: "index_annotations_on_song_instance_id", using: :btree
  end
  ...
  create_table "external_song_texts", force: :cascade do |t|
    t.string   "short_desc"
    t.text     "text"
    t.string   "url"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer  "song_id"
    t.index ["song_id"], name: "index_external_song_texts_on_song_id", using: :btree
  end

  create_table "external_witnesses", force: :cascade do |t|
    t.string   "label"
    t.string   "url"
    t.integer  "song_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["song_id"], name: "index_external_witnesses_on_song_id", using: :btree
  end
  ...
  create_table "performances", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer  "song_id"
    t.index ["song_id"], name: "index_performances_on_song_id", using: :btree
  end
  ...
  create_table "song_instances", force: :cascade do |t|
    ...
    t.index ["manuscript_id"], name: "index_song_instances_on_manuscript_id", using: :btree
    t.index ["song_id"], name: "index_song_instances_on_song_id", using: :btree
  end
