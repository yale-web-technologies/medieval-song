...
class ManuscriptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manuscript" do
    assert_difference('Manuscript.count') do
      post manuscripts_url, params: { manuscript: { long_desc: @manuscript.long_desc, manifest_url: @manuscript.manifest_url, title: @manuscript.title } }
    end
  ...
  test "should update manuscript" do
    patch manuscript_url(@manuscript), params: { manuscript: { long_desc: @manuscript.long_desc, manifest_url: @manuscript.manifest_url, title: @manuscript.title } }
